...
// Play a tone with exponential decay (bell-like)
...
// Play a tone with slow attack (soft feel)
...
// --- 2. Chime (차임벨) - Bright bell tones, fast decay ---
...
// --- 3. Soft (부드러운) - Low volume, slow attack ---
...
// --- 4. Digital (디지털) - Square wave, retro game feel ---
...
// --- 5. Melody (멜로디) - 4+ note short melody ---
...
// Backward-compatible exports for any direct callers
export function playWarningAlarm(): void { classicWarning(); }
export function playStartAlarm(): void { classicStart(); }
export function playEndAlarm(): void { classicEnd(); }

// ===== Alarm Scheduler =====
// Prevents duplicate alarms using a Set that resets each minute
